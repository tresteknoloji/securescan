...
const defaultTranslations = {
  tr: {
    ...
    current: "Güncel",
    findings: "bulgu",
    report_theme: "Rapor Teması",
    dark: "Koyu",
    light: "Açık",
    rescan_started: "Tekrar tarama başlatıldı - yeni yineleme oluşturuldu",
    // CVE Database page
    cve_database_title: "CVE Veritabanı",
    cve_database_subtitle: "Ulusal Zafiyet Veritabanı + CISA KEV",
    sync_kev: "KEV Senkronize",
    incremental_sync: "Artımlı Sync",
    full_sync: "Tam Senkronizasyon (320K+)",
    total_cves: "Toplam CVE",
    cisa_kev: "CISA KEV",
    active_exploits: "Aktif Exploitler",
    cve_by_year: "Yıllara Göre CVE Dağılımı",
    search_cve: "CVE Veritabanında Ara",
    search_placeholder: "CVE ID, ürün veya açıklama ara...",
    severity_filter: "Seviye",
    kev_filter: "KEV Durumu",
    year_filter: "Yıl",
    all_severities: "Tüm Seviyeler",
    kev_only: "Sadece KEV",
    non_kev: "KEV Olmayan",
    all_years: "Tüm Yıllar",
    cve_results: "sonuç",
    no_cves_found: "CVE bulunamadı",
    cve_details: "CVE Detayları",
    cvss_score: "CVSS Skoru",
    published: "Yayın Tarihi",
    modified: "Güncelleme",
    cpe_matches: "Etkilenen Ürünler",
    kev_info: "CISA KEV Bilgisi",
  ...
  en: {
    ...
    // CVE Database page
    cve_database_title: "CVE Database",
    cve_database_subtitle: "National Vulnerability Database + CISA KEV",
    sync_kev: "Sync KEV",
    incremental_sync: "Incremental",
    full_sync: "Full Sync (320K+)",
    total_cves: "Total CVEs",
    cisa_kev: "CISA KEV",
    active_exploits: "Active Exploits",
    cve_by_year: "CVE Distribution by Year",
    search_cve: "Search CVE Database",
    search_placeholder: "Search CVE ID, product or description...",
    severity_filter: "Severity",
    kev_filter: "KEV Status",
    year_filter: "Year",
    ...
    all_years: "All Years",
    cve_results: "results",
    no_cves_found: "No CVEs found",
    cve_details: "CVE Details",
    cvss_score: "CVSS Score",
    published: "Published",
    modified: "Modified",
    cpe_matches: "Affected Products",
    kev_info: "CISA KEV Info",
